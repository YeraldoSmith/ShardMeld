...
A second Linux run exposed another mock that rejected a legal Endgame CANCEL;
after accepting and validating that standard message, the rarest-first
regression passed thirty consecutive targeted runs.
