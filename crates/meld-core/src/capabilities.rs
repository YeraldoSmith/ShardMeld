...
pub fn capabilities_report() -> CapabilitiesReport {
    CapabilitiesReport {
        ...
        implemented: vec![
            ...
            "automatic-downloader-tracker-completed".to_owned(),
            "graceful-ctrl-c-seed-shutdown".to_owned(),
            "bounded-four-peer-upload-seeding".to_owned(),
            "periodic-seed-tracker-reannounce".to_owned(),
            "aggregate-upload-rate-limit".to_owned(),
            "fifo-block-upload-fairness".to_owned(),
            ...
            "native-macos-analysis-and-receive-ui".to_owned(),
        ],
        deferred: vec![
            "dht".to_owned(),
        ...
        limits: vec![
            ...
            "fixed-four-active-upload-peers".to_owned(),
            "fifo-block-fairness-without-tit-for-tat-choking".to_owned(),
            "tracker-stopped-not-guaranteed-after-forced-termination".to_owned(),
            "macos-apple-silicon-desktop-package-only".to_owned(),
            "desktop-receive-requires-meld-descriptor".to_owned(),
